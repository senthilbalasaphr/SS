...
public class MyIndex {
    ...
    public static void main(String[] args) {
        Map<String, String> companies = MyIndexCompanies();
    ...
    public static Map<String, String> MyIndexCompanies() {
      String   fileName = "/Users/baps/Documents/Stocks/ts/MyIndexstock.txt";
